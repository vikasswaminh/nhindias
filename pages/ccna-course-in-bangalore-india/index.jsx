...
const index = () => {
    return (
        <Layout>
            <Seo
                title=" Best CCNA Course | CCNA Course in Bangalore, india. Top Cisco certification training"
                desc="CCNA Course in Bangalore. CCNA Training on Cisco 200-301 exam and certification prep"
            />
